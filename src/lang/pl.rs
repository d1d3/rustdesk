...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "ProVision może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować ProVision w swoim systemie."),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić ProVision na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [ProVision Input]."),
        ...
        ("Language", "Język"),
        ("Keep ProVision background service", "Zachowaj usługę ProVision w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji ProVision, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show ProVision", "Pokaż ProVision"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji ProVision uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu ProVision"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy ProVision, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników ProVision w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z ProVision w Twojej sieci."),
        ...
        ("verify_ProVision_password_tip", "Weryfikuj hasło ProVision"),

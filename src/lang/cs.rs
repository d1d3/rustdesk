...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k ProVision síti..."),
        ...
        ("About", "O aplikaci"),
        ("Slogan_tip", "Pro bezproblémovou digitální práci 21. století"),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), ProVision v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak ProVision do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci ProVision udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci ProVision udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby ProVision mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [ProVision vstup]."),
        ...
        ("Quit", "Ukončit"),
        ("doc_mac_permission", "https://ProVision.com/docs/en/manual/mac/#enable-permissions"),
        ("Help", "Nápověda"),
        ...
        ("Language", "Jazyk"),
        ("Keep ProVision background service", "Zachovat službu ProVision na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace ProVision, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show ProVision", "Zobrazit ProVision"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění ProVision \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění ProVision \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného ProVisionu."),
        ...
        ("install_cert_tip", "Instalace certifikátu ProVision"),
        ("confirm_install_cert_tip", "Jedná se o testovací certifikát ProVision, kterému lze důvěřovat. Certifikát bude v případě potřeby použit k důvěryhodnosti a instalaci ovladačů ProVision."),
        ...
        ("verify_ProVision_password_tip", "Ověření hesla ProVision"),

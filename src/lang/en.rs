...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the ProVision network..."),
        ...
        ("install_tip", "Due to UAC, ProVision can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install ProVision to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant ProVision \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant ProVision \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow ProVision to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [ProVision Input] service."),
        ...
        ("doc_fix_wayland", "https://ProVision.com/docs/en/manual/linux/#x11-required"),
        ("server_not_support", "Not yet supported by the server"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next ProVision application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("Slogan_tip", "For seamless digital work of the 21st century"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant ProVision \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running ProVision."),
        ("config_microphone", "In order to speak remotely, you need to grant ProVision \"Record Audio\" permissions."),
        ...
        ("install_cert_tip", "Install ProVision certificate"),
        ("confirm_install_cert_tip", "This is a ProVision testing certificate, which can be trusted. The certificate will be used to trust and install ProVision drivers when required."),
        ...
        ("enter_ProVision_passwd_tip", "Enter ProVision password"),
        ("remember_ProVision_passwd_tip", "Remember ProVision password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_ProVision_password_tip", "Verify ProVision password"),

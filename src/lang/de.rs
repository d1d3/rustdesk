...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem ProVision-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann ProVision in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren ProVision auf dem System."),
        ("Click to upgrade", "Upgrade"),
        ("Click to download", "Zum Herunterladen klicken"),
        ("Click to update", "Update"),
        ("Configure", "Konfigurieren"),
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie ProVision Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie ProVision die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie ProVision erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"ProVision Input\" ein."),
        ...
        ("Quit", "Beenden"),
        ("doc_mac_permission", "https://ProVision.com/docs/de/manual/mac/#berechtigungen-aktivieren"),
        ("Help", "Hilfe"),
        ...
        ("Language", "Sprache"),
        ("Keep ProVision background service", "ProVision im Hintergrund ausführen"),
        ...
        ("Show ProVision", "ProVision anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie ProVision die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie ProVision die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von ProVision auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "ProVision-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein ProVision-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um ProVision-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_ProVision_password_tip", "ProVision-Passwort bestätigen"),

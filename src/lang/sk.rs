...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About", "O ProVision"),
        ("Slogan_tip", "Pre bezproblémovú digitálnu prácu 21. storočia"),
        ("Privacy Statement", ""),
        ("Mute", "Stíšiť"),
        ("Build Date", ""),
        ("Version", ""),
        ...
        ("install_tip", "V niektorých prípadoch ProVision nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ...
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii ProVision udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii ProVision udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii ProVision udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [ProVision Input] službu."),
        ...
        ("Language", ""),
        ("Keep ProVision background service", ""),
